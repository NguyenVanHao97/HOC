...
const data = [
{ id: 1, name: 'Red Wine and Mint Soufflé', image: require('../access/Img2.png') },
{ id: 3, name: 'White Wine Toffee', image: require('../access/Img3.png') },
{ id: 4, name: 'Vanilla Pud', image: require('../access/Img4.png') },
{ id: 5, name: 'Cured Vegetables & Mutton', image: require('../access/Img2.png') },
]
const ListCard = () => {
...
<View style={styles.container}>
   <TouchableOpacity>
      ...
      <View style={styles.profile}>
         <Image style={styles.avatar} source={require('../access/Avatar1.png')} />
